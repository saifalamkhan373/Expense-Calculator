  ...
  try {
    if (req.body && req.body.name && req.body.desc && req.body.price) {
      ...
      if (req.files && req.files.length > 0) {
        // If files were uploaded, use the first file's filename
        new_product.image = req.files[0].filename;
      } else {
        // If no files were uploaded, you can set a default image or leave it undefined
         new_product.image = 'default-image.jpg';
      }
